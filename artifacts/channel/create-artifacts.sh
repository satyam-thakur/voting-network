...
echo "#######    Generating anchor peer update for voterMSP  ##########"
configtxgen -profile BasicChannel -configPath . -outputAnchorPeersUpdate ./voterMSPanchors.tx -channelID $CHANNEL_NAME -asOrg voterMSP

echo "#######    Generating anchor peer update for vcmsMSP  ##########"
configtxgen -profile BasicChannel -configPath . -outputAnchorPeersUpdate ./vcmsMSPanchors.tx -channelID $CHANNEL_NAME -asOrg vcmsMSP
